...
void MainWindow2::WriteToFile(QString info) {
...
void MainWindow2::degre() {
    ...
    QString info = ui->degrees->text();
    QString otv = QString::number(numb, 'g', 15);
    WriteToFile(info+"="+otv);
}
...
void MainWindow2::degre2() {
    ...
    QString info = ui->degrees_2->text();
    QString otv = QString::number(numb, 'g', 15);
    WriteToFile(info+"="+otv);
}
...
void MainWindow2::on_actionCalculation_list_triggered() {
